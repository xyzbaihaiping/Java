...
import com.chinasofti.ui.MainActivity;
...
public class ServiceCenter {
	...
	public void changeStatus(ServerStatus status)
	{
		...
		//MainFrame.getMainFrame().statusChanged(status);
	}
